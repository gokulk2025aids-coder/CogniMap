# EduRadar — Explainable Early-Warning System for Academic Risk & Performance Prediction

EduRadar is an end-to-end, production-structured machine learning platform that predicts student academic risk, final grades, and performance segments — and explains every prediction in plain English, with personalized intervention recommendations attached.
